...
class CustomHeap():
    ...
    def insert(self, item):
        ...
        while value < self.heap_array[parent_index - 1][0]:
    ...
    def pop_min(self):
        ...
        value = self.heap_array[0][0]
        index = 1
        child_index = 2 * index
        if child_index + 1 <= array_size and self.heap_array[child_index - 1][0] > self.heap_array[child_index][0]:
            child_index += 1

        while value > self.heap_array[child_index - 1][0]:
